...
public:
    ...
    // std::vector<cv::Mat> depths; // for now, debug
...
// private:
    ...
    float *depths_cuda;
    float *anchor_depth_cuda;
    float3 *normals_guess_cuda;

    // std::vector<unsigned char*> h_mask_array;
    unsigned char** h_mask_array;
    unsigned char** d_mask_array;
